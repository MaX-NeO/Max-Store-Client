...
import { Cross, LayoutDashboard, Power, User, X } from 'lucide-react'
import { useEffect, useRef, useState } from "react"
import { Login, Register } from "../api/api"
import { getRole, isLoginValid, storeToken } from "../service/auth"
                    ...
                    {isLogin ? (
                        <>
                            {userRole === "User" ?
                                (
                                    <>
                                        <button className="h-9 w-10 flex justify-center items-center border-2 border-red-500 text-red-500 rounded-full hover:bg-red-500 hover:text-white ml-4 shadow-md" onClick={handleLogout}>
                                            <Power className="h-6 w-6" />
                                        </button>
                                    </>
                                ) : (
                                    <>
                                        <Link to='/admin/dashboard' className="h-9 w-10 flex justify-center items-center border-2 border-purple-500 text-purple-500 rounded-full hover:bg-purple-500 hover:text-white ml-4 shadow-md">
